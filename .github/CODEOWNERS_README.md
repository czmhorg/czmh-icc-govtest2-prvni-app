...
governance reconcile z konfigurace projektu `govtest2` v gov repu
(`conf.d/projects/govtest2.conf`, klíč `pr_reviewers_team`).
...
Odeberte klíč `pr_reviewers_team` z `conf.d/projects/govtest2.conf`
